<template>
    ...
    <body>
        <div class="container">
            <div class="wrapper">
                <div class="title"><span>ADDRESS BOOK &nbsp;</span><i class="far fa-address-book"
                ...
                <form action="#" @submit="submitForm">
                    ...
                    <div class="signup-link">Not a member? <router-link to="/signup">Signup now</router-link>
                    </div>
                </form>
            </div>
        </div>
...
export default {
 ...
 methods: {
    submitForm(event){
        ...
        AddressBookService.login(this.formValues.email,this.formValues.password).then((response) => {
